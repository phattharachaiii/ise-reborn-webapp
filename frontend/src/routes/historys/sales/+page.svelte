...
<section class="mx-auto max-w-5xl px-4 py-6 space-y-4">
	...
	<div class="flex items-center justify-between bg-white border border-surface p-4 rounded-xl">
		<div>
			...
			<p class="text-sm text-neutral-500">View your successful sales or related listings</p>
		</div>
		<button
	...
	{:else if items.length === 0}
		...
		<div class="rounded-xl border border-dashed border-surface bg-white p-10 text-center space-y-2">
			<div class="text-lg font-semibold">No sales history yet</div>
			<p class="text-sm text-neutral-500">
				Start selling your items by clicking the “Post Item” button at the top right.
			</p>
			<a
				href="/post"
					...
					<div class="flex gap-3">
						...
						<div class="flex-1 min-w-0">
							...
							<div class="mt-1 text-sm text-neutral-600">
								Buyer: <span class="font-medium">{it.buyer?.name}</span>
